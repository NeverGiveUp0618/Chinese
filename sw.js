const CACHE = "treasure-writing-v44";
const CORE = ["./", "./index.html", "./data.js", "./essay-library.js", "./check.js", "./app.js", "./manifest.json", "./audio/baibai/manifest.js", "./assets/baibai-base.png"];
